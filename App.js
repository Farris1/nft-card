...
import ethIcon from "./src/images/icon-ethereum.svg";
import iconClock from "./src/images/icon-clock.svg";
import avatarImage from "./src/images/image-avatar.png";
import iconView from "./src/images/icon-view.svg";
import "./src/App.css";
...
export default function App() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("h3", { className: "content" }, "Equilibrium #3429"),
      React.createElement(
        "p",
      ...
      React.createElement(
        ...
        React.createElement("p", { className: "price para" }, "0.041 ETH")
      ),
      React.createElement(
        "div",
